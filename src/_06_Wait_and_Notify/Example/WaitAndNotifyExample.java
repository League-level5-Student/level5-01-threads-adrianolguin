...
public class WaitAndNotifyExample {
	/*
	 * Run the code below. How is the output? You'll most likely notice that the
	 * first thread finishes printing all of its statements before the second thread
	 * prints its first statement.
	 * 
	 * Now, change s1 and s2 to take in new SynchedThreadPrinter objects instead of
	 * ThreadPrinter. How has the output changed?
	 * 
